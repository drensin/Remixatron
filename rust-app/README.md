...
### How It Worked
V1 was built on a heavy scientific stack: **Librosa** for audio features, **Sickit-Learn** for clustering, and **PyGame** for audio playback.
